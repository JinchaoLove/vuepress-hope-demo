...
import { useArticles, useBlogOptions, useCategoryMap, useTagMap, useTimelines, } from "@theme-hope/modules/blog/composables/index";
...
export default defineComponent({
    ...
    setup() {
        ...
        const bloggerName = computed(() => blogOptions.value.name ||
        ...
        return () => {
            ...
            return h("div", {
                ...
                h(SocialMedia),
                h("div", { class: "vp-blog-counts" }, countItems.map(([path, count, locale]) => h(VPLink, { class: "vp-blog-count", to: path }, () => [
                    h("div", locale),
